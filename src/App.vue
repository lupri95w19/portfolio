...
<template>
	<div class="w-screen">
		<section class="h-[90vh] mb-[2rem] mt-[1rem]">
				...
				<div class="grid grid-cols-12 gap-4">
					...
					<div class="p-0 rounded-lg col-span-8 w-full rounded-t-lg h-[550px]">
						...
						>
							...
							<!-- Testo terminale -->
							<div
								class="text-lg leading-relaxed p-4 overflow-y-auto h-[calc(100%-80px)]"
							>
								...
								<!-- Visualizza il contenuto dinamico del terminale -->
		...
		<section class="h-[90vh] mb-[2vh] mt-[1rem]">
			<div class="max-w-screen-lg container m-auto">
				<h1>Su di me</h1>
				...
				<div class="grid grid-cols-12">
					...
					<div class="col-span-8">
						<p>testo tanto testo Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque adipisci natus eius iste dolores voluptatum possimus provident. Ipsam ipsum et corrupti, harum quasi, totam reprehenderit officiis porro maxime tempora eos!</p>
					</div>
